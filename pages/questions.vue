...
<template>
  <div h-full w-full flex items-center justify-center bg-cover bg-center bg-no-repeat class="bg-[url(/bg.gif)]">
    <div relative flex flex-col items-center justify-center gap-4 rounded-md bg-zinc-950 p-8 class="w-1/3 bg-opacity-85">
